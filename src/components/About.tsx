      ...
      <div className='mx-auto max-w-[1080px]'>
        ...
        <div className='flex w-full justify-between gap-x-5'>
          <div className='text-[14px] text-gray-700' style={{ flex: 1 }} data-aos='fade-down'>
            ...
            that serve both people and the planet. Inspired by the theme{' '}
            <i>"Le numérique au service du vivant, des communautés et de l’environnement,"</i> Hackafako is a platform
            that connects like-minded individuals passionate about using technology to address real-world challenges.
            <br /> <br />
